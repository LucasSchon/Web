...
<body>
  <big>
    <div class="container" style="margin-top: 15px; background: rgba(255,255,255,0.7);">
      ...
      <hr>
      <center>
      <a href="cad-alunos.php">
         <img src="imgs/cad-alunos.png" class="thumb-link" alt="Cadastrar Alunos"> 
      </a>
      <a href="cad-professores.php">
         <img src="imgs/cad-professores.png" class="thumb-link" alt="Cadastrar Alunos"> 
      </a>
      </center>
      </div>
    </div>
